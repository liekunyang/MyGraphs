...
class MyGraphs:
    def __init__(self, datafolder="", day="", which=None, window=60, cuvette=600):
        ...
        # Create master file
        self.create_masterdf(derive=True, denoise=True)
    ...
    def normalize_chlorophyll(self, s):
        ...
        for i in ['d32dt', 'd32dt_d', 'd32dt_cd', 'd44dt', 'd45dt', 'd46dt', 'd47dt', 'd49dt', 'dtotalCO2dt', 'enrichrate47', 'enrichrate49']:
